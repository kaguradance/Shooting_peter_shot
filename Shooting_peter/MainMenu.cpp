...
void MainMenu::initText()
{
	...
	this->menu[0].setPosition(sf::Vector2f(100, 200));
	...
	this->menu[1].setPosition(sf::Vector2f(100, 300));
	...
	this->menu[2].setPosition(sf::Vector2f(100, 400));
	...
	this->devName.setPosition(sf::Vector2f(100, 700));
